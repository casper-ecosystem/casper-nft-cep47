...
Contract endpoints handle token operations with your account and other accounts. Refer to the list of [endpoints](#casper-nft-cep-47-functions) in the introduction section and [endpoint event stream](#contract-interaction-and-events) details in the token management section.
