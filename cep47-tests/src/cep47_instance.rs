...
use casper_types::{bytesrepr::ToBytes, runtime_args, CLTyped, Key, RuntimeArgs, U256, account::AccountHash};
...
impl CEP47Instance {
    ...
    pub fn transfer<T: Into<Key>>(&self, sender: AccountHash, recipient: T, token_ids: Vec<TokenId>) {
        self.0.call_contract(
            sender,
            "transfer",
            runtime_args! {
